(function (global, factory) {
  ...
  function fireRouterEvent(type, detail) {
    return !window.dispatchEvent(new CustomEvent('vaadin-router-' + type, { cancelable: type === 'go', detail: detail }));
  }
  ...
  var notFoundResult = new function NotFoundResult() {
    classCallCheck(this, NotFoundResult);
  }();
  ...
  var Router = function (_Resolver) {
    ...
    function Router(outlet, options) {
      ...
      var _this = possibleConstructorReturn(this, (Router.__proto__ || Object.getPrototypeOf(Router)).call(this, [], Object.assign({
        // Default options
       ...
       */
      _this.location;
      _this.location = createLocation({ resolver: _this });
    ...
    createClass(Router, [{
      ...
      value: function render(pathnameOrContext, shouldUpdateHistory) {
        ...
        .then(function (context) {
          ...
          if (renderId === _this2.__lastStartedRenderId) {
            ...
            _this2.location = createLocation({ pathname: pathname, resolver: _this2 });
      ...
      value: function __fullyResolveChain(originalContext) {
        ...
        return this.__amendWithResolutionResult(currentContext).then(function (amendedContext) {
          ...
          return amendedContext.next().then(function (nextContext) {
            ...
            return nextContext && nextContext !== notFoundResult ? _this3.__fullyResolveChain(initialContext, nextContext) : _this3.__amendWithOnBeforeCallbacks(initialContext);
          });
        });
      }
    }, {
      ...
      value: function go(pathname) {
        return fireRouterEvent('go', { pathname: pathname });
      }
    }]);
    return Router;
  }(Resolver);
